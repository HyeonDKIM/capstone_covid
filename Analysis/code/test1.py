...
# 뉴스 및 로밍 데이터 불러오기
data_01 = pd.read_excel('C:/Users/USER/Desktop/jin/data/1_NewsList.xls', sheet_name='List', encoding='utf-8')
data_02 = pd.read_csv('C:/Users/USER/Desktop/jin/data/1_Roaming_data.csv')

# 로밍데이터 열별로 분할
iso = data_02['iso'].str.upper()  # 로밍데이터 iso 대문자로 변환
departure = data_02['departure']
count = data_02['count']
...
# 뉴스 데이터 요약
sample = data_01[['제목', '게시일자', '감염병명']]  # 제목 게시일자 감염병명 3가지 열 추출
sample = sample.loc[data_01['감염병명'].str.contains('COVID-19', na=False)]  # 감염병명이 COVID-19인 행 추출 및 결측값 제거
sample_title = sample['제목']  # 제목 열만 추출
k = data_02[['return', 'iso', 'departure', 'count']]
...
print('데이터 갯수 : ', b)
print(count_df)
count_df.to_pickle('data_Result_01_10.pkl')
