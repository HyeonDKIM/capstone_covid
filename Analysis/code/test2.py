...
# 뉴스 및 로밍 데이터 불러오기
data_11 = pd.read_excel('C:/Users/USER/Desktop/jin/data/2_NewsList.xls', sheet_name='List', encoding='utf-8')
data_12 = pd.read_csv('C:/Users/USER/Desktop/jin/data/2_Roaming_data.csv')


# 로밍데이터 열별로 분할
iso = data_12['iso'].str.upper()  # 로밍데이터 iso 대문자로 변환
departure = data_12['departure']
count = data_12['count']
...
# 뉴스 데이터 요약
sample = data_11[['제목', '게시일자', '감염병명']]  # 제목 게시일자 감염병명 3가지 열 추출
sample = sample.loc[data_11['감염병명'].str.contains('COVID-19', na=False)]  # 감염병명이 COVID-19인 행 추출 및 결측값 제거
sample_title = sample['제목']  # 제목 열만 추출
k = data_12[['return', 'iso', 'departure', 'count']]
...
print('데이터 갯수 : ', b)
print(count_df)
count_df.to_pickle('data_Result_02_10.pkl')
